    ...
    return (
      <span id="connector-land-about">
        ...
        >
					...
					<p>Take into account that most connectors on connector.land are running software that still changes often, and most maintainers will take their connector into (extended) maintenance mode without warning and probably without refunds, so it's probably wise to avoid putting more money onto any connectors than you are willing to lose.</p>
        </Modal>
      </span>
    );
  }
