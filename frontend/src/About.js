      ...
      <span id="vish-about">
        ...
        >
          ...
          <p>This website and the scripts that generate the data displayed here are <a href="https://github.com/nik-suri/vish" target="_blank" rel="noopener noreferrer">open source</a>.</p>
					...
					<p>Take into account that most connectors on Vish are running software that still changes often, and most maintainers will take their connector into (extended) maintenance mode without warning and probably without refunds, so it's probably wise to avoid putting more money onto any connectors than you are willing to lose.</p>
        </Modal>
      </span>
    );
  }
